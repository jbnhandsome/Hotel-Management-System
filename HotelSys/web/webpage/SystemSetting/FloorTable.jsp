    ...
    layui.use(['util', 'layer', 'table'], function() {
        $(document).ready(function() {
            ...
            var tableIns = table.render({
                elem: '#tableID',
                id: 'tableID',
                url: 'http://localhost:8080/web_war_exploded/FloorInfoServlet',
                cols: [
                    [{
                        field: 'floorId',
                        title: 'ID',
            ...
            table.on('tool', function(obj) {
                ...
                if(layEvent === 'detail') { //查看功能
                    ...
                    layer.prompt({
                        ...
                        $.post('http://localhost:8080/web_war_exploded/QueryFloorNameServlet', params, function updateCheck(data) {
                            if(data === "1" || data === "2") {
                                layer.close(index);
                                table.reload('tableID', {
                                    where: {
            ...
            $('#insertButton').click(function() {
                layer.prompt({
                    ...
                    $.post('http://localhost:8080/web_war_exploded/QueryFloorNameServlet', params, function(data) {
                        if(data === "1") {
                            layer.close(index);
                            table.reload('tableID', {
                                where: {
