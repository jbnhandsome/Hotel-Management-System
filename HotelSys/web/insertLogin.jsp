...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="password" name="loginPwd" id="pwd1" lay-verify="required" autocomplete="off"
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="loginNickName" lay-verify="required" autocomplete="off"
    ...
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('submit(insertRome)', function (data) {
            ...
            if (pwd1 != pwd2) {
                ...
                $.post('http://localhost:8080/web_war_exploded/InsertLoginServlet', JSON.stringify(data.field), function (code) {
                    if (code === 1) {
                        layer.alert('注册成功！', {
                            title: '成功',
                            icon: 6,
