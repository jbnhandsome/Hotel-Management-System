...
<form class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="tel" id="orderPhone"  autocomplete="off" placeholder="预定人电话" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="orderIDcard" lay-verify="required" placeholder="公民身份证号" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input"  id="orderAllTime" placeholder="抵店时间 - 离店时间" readonly>
            </div>
        </div>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        // 开始赋值
        $.post('http://localhost:8080/web_war_exploded/QueryOrderInfoServlet', queryId, function(orderInfo) {
