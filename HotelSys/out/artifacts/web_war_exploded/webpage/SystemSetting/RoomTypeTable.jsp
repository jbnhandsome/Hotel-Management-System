    ...
    layui.use(['util', 'layer', 'table'], function() {
        $(document).ready(function() {
            ...
            var tableIns = table.render({
                elem: '#tableID',
                id: 'tableID',
                url: 'http://localhost:8080/web_war_exploded/RoomTypeServlet',
                cols: [
                    [{
                        field: 'typeId',
                        title: 'ID',
            ...
            table.on('tool', function(obj) {
                ...
                if(layEvent === 'detail') {
                    ...
                    layer.prompt({
                        ...
                        $.post('http://localhost:8080/web_war_exploded/QueryRoomTypeNameServlet', params, function(data) {
                            if(data === "1" || data === "2") {
